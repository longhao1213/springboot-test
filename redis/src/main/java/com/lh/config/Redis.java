...
public class Redis implements InitializingBean, DisposableBean {
	 ...
	 * @return
	 */
	public Object appTokenKeys() {
		List rltList = new ArrayList();
		if (redisTemplate != null) {
			return redisTemplate.execute(new RedisCallback<Object>() {
				public Object doInRedis(RedisConnection connection)
						throws DataAccessException {
					Set<byte[]> keyset = connection.keys("*APP*".getBytes());
					keyset.addAll(connection.keys("*WXSMALL*".getBytes()));
					Long startTime = System.currentTimeMillis();
					final byte[][] rawKeys = new byte[keyset.size()][];
					int i = 0;
					...
					List rltList = new ArrayList();
					for(byte[] value:re){
						rltList.add(serializer.deserialize(value));
					}
//
//					System.out.println("反序列化耗时："+(System.currentTimeMillis()-startTime));
					return rltList;
				}
			});
		}
...
//		return false;
	 ...
	 * @return
	 */
	public Object get(final Object key,Class<? extends Object> aClass) {
//		if (redisTemplate != null) {
//			return redisTemplate.execute(new RedisCallback<Object>() {
//				public Object doInRedis(RedisConnection connection)
//						throws DataAccessException {
...
//			});
//		}
        String json = (String) valOpsObj.get(key);
        JsonMapper jsonMapper = new JsonMapper();
        Object o1 = jsonMapper.fromJson(json, aClass);
        return o1;
